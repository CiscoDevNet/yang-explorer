...
class DeviceProfile(models.Model):
    ...
    address = models.CharField(max_length=15,  verbose_name='Device IP')
    port = models.CharField(max_length=5, default='22', verbose_name='SSH Port')
